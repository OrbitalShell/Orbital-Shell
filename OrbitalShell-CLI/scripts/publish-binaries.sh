...
echo "(br)(f=green) publish framework-dependent binaries: (b=darkgreen,f=yellow)net5.0 (rdc)(br)"
dotnet publish --configuration Release --output bin/publish/net5.0/

# framework-independent (self-contained) - current plateforms

echo "(br)(f=green)publish self-contained binaries: (b=darkgreen,f=yellow)net5.0(rdc)(br)"
...
echo "(br)(f=green)nuget publish framework-dependent binaries: (b=darkgreen,f=yellow)net5.0 (rdc)(br)"
