...
echo "(EdgeTopLeft,EdgeTopRight)1 (2 lines box)(br)(EdgeBottomLeft,EdgeBottomRight)"
...
echo "(EdgeDoubleTopLeft,EdgeDoubleTopRight)1 (2 lines box)(br)(EdgeDoubleBottomLeft,EdgeDoubleBottomRight)"
