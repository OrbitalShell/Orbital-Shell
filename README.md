# Orbital Shell
 ...
 &nbsp; | &nbsp;
-- | --
<img src="docs/assets/img/robotazteque.png" align="top" style="float:left;margin-right:8px"/> | <b>Orbital Shell</b> is a multi-plateform (**windows, linux, macos, arm**)<br> command shell (according to .Net Core supported platforms<br> and APIs compatibilities), inspired by <b><i>bash</i></b> and **POSIX**<br>recommendations. It provides any usual bash shell feature<br>(even if modernized) and 'user friendly' syntaxes allowing to access<br>(get/set/call) C# objects.<br>Developed using **C# 8, .NET Core 3.1/Net 5 and .NET Standard 2.1**
