...
namespace OrbitalShell.Component.EchoDirective
{
    ...
    public static class Shortcuts
    {
        ...
        public static string DefaultBackgroundCmd => GetCmd(EchoDirectives.b + "", Console.DefaultBackground.ToString().ToLower());
        public static string DefaultForegroundCmd => GetCmd(EchoDirectives.f + "", Console.DefaultForeground.ToString().ToLower());
