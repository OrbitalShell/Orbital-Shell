...
namespace OrbitalShell.Component.Shell.Variable
{
    ...
    public class ShellEnvironment : DataObject
    {
        ...
        {            
            ...
            AddValue(ShellEnvironmentVar.profile, new DirectoryPath(context.CommandLineProcessor.Settings.ShellAppDataPath), true);
            ...
            AddValue(ShellEnvironmentVar.settings_module_providerUrls, new List<string> { "https://raw.githubusercontent.com/franck-gaspoz/orbital-shell/master/repo/module-list.txt" });
